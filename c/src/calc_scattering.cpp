...
void calc_scattering(double* crossings, size_t rows, double* inp_pwr, EA_args EA,
    ...
    // cout << "E_BANDWIDTH " << E_BANDWIDTH << endl;
    // cout << "SCATTERING_RES_MODES " << SCATTERING_RES_MODES << endl;
    ...
    double(*pwr_ptr)[num_lons] = reinterpret_cast<double(*)[num_lons]>(inp_pwr);
